	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="list">Applications</g:link></li>
			...
			<ol class="property-list ptoApplication">
				...
				<li class="fieldcontain">
					<span id="businessUnit-label" class="property-label"><g:message code="ptoApplication.businessUnit.label" default="Business Unit" /></span>
						...
						<span class="property-value" aria-labelledby="businessUnit-label"><g:link controller="businessUnit" action="show" id="${ptoApplicationInstance?.businessUnit?.id}">${ptoApplicationInstance?.businessUnit?.businessUnitName}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="cbt-label" class="property-label"><g:message code="ptoApplication.cbt.label" default="Cbt" /></span>
						...
						<span class="property-value" aria-labelledby="cbt-label"><g:link controller="user" action="show" id="${ptoApplicationInstance?.cbt?.id}">${ptoApplicationInstance?.cbt?.firstName}</g:link></span>
