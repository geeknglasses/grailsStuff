			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="answerType" title="${message(code: 'question.answerType.label', default: 'Answer Type')}" />
				...
				<g:each in="${questionInstanceList}" status="i" var="questionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: questionInstance, field: "answerType")}</td>
