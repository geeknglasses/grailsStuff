	...
	<body>
		...
		<div id="show-question" class="content scaffold-show" role="main">
			...
			<ol class="property-list question">
				...
				<g:if test="${questionInstance?.answerType}">
				<li class="fieldcontain">
					<span id="answerType-label" class="property-label"><g:message code="question.answerType.label" default="Answer Type" /></span>
					
						<span class="property-value" aria-labelledby="answerType-label"><g:fieldValue bean="${questionInstance}" field="answerType"/></span>
