	...
	<body>
		...
		<div id="show-workflow" class="content scaffold-show" role="main">
			...
			<ol class="property-list workflow">
				...
				<g:if test="${workflowInstance?.description}">
				...
				<g:if test="${workflowInstance?.questions}">
				<li class="fieldcontain">
					<span id="questions-label" class="property-label"><g:message code="workflow.questions.label" default="Questions" /></span>
					
						<g:each in="${workflowInstance.questions}" var="q">
